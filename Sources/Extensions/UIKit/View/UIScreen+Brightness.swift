...
fileprivate extension UIScreen {
    ...
    //link key
    private static var brightnessLinkKey = "com.then.uikit.brightness.link"
    
    //最终的亮度值
    private static var brightnessKey = "com.then.uikit.brightness.brightness"
    
    //每次修改的亮度值
    private static var brightnessStepKey = "com.then.uikit.brightness.step"
