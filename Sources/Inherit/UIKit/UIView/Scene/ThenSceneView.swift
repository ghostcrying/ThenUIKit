...
public class ThenSceneView: UIView {
...
extension ThenSceneView {
    
    @objc private func gestureHandleTap(_ gestureRecognize: UIGestureRecognizer) {
