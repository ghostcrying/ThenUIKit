...
public class ThenCircleProgressView: UIView {
    ...
    private lazy var progressLayer: ThenCircleProgressView.ContentLayer = ThenCircleProgressView.ContentLayer()
}

extension ThenCircleProgressView {
    ...
    class ContentLayer: CALayer {
        ...
        private func render() {
            ...
            let insetRect = bounds.inset(by: borderWidth.then.insets)
