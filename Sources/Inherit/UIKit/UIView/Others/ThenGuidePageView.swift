...
@IBDesignable
open class ThenGuidePageView: UIView {
    ...
    open override func layoutSubviews() {
        ...
        pageControl.center = CGPoint(x: bounds.then.centerX, y: bounds.height - 78)
        enter.center = CGPoint(x: bounds.then.centerX, y: pageControl.then.centerY)
    }
    ...
    class PageControl: UIView {
        ...
        public var totalCount: Int = 0 {
            didSet {
                ...
                totalCount.then.repeating { _ in
